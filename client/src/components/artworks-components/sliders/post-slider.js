...
export function PostSlider({multiples, useFilter, current, setCurrent}) {
    ...
    return (
        <div className="postSliderContainer">
            ...
            <div className="pickSlideButtonsContainer">
                ...
                <div key={index} className="pickSlideButton" onClick={() => setCurrent(index)} style={{background: (index === current) ? 'rgba(0, 21, 252, 0.5)' : 'rgba(255, 255, 255, 0.2)'}}></div>
                )}
            </div>
            <img 
